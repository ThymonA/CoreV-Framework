----------------------- [ CoreV ] -----------------------
-- GitHub: https://github.com/ThymonA/FiveM-Mustache
-- License: MIT License
-- Author: Olivine Labs <projects@olivinelabs.com>
--         ThymonA <contact@arens.io>
-- Name: FiveM-Mustache
-- Version: 1.3.1-0
...
local _mustache = class('mustache')

function _mustache:render(...)
    return CreateRenderer(...).render(...)
end

-- FiveM manipulation
_ENV.mustache = _mustache
_G.mustache = _mustache
_ENV.render = function(...) _mustache:render(...) end
_G.render = function(...) _mustache:render(...) end