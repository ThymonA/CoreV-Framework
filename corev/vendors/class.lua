----------------------- [ CoreV ] -----------------------
-- ɢɪᴛʜᴜʙ: https://github.com/siffiejoe/lua-classy/
-- ʟɪᴄᴇɴꜱᴇ: MIT License
-- ᴅᴇᴠᴇʟᴏᴘᴇʀ: siffiejoe
-- ᴘʀᴏᴊᴇᴄᴛ: lua-classy
-- ᴠᴇʀꜱɪᴏɴ: unknown
-- ᴅᴇꜱᴄʀɪᴘᴛɪᴏɴ: Class-based OO library for Lua
----------------------- [ CoreV ] -----------------------
...
local function create_class( _, name, ... )
  ...
  index.set = function(self, prop, value)
    if (not prop and not value) then return end
